          ...
          <div className="lg:sticky mx-auto lg:top-20 lg:left-24 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24 px-24 space-y-2">
            <div className="min-w-fit inline-block">
              ...
              <p className="text-slate-950 2xl:text-lg xl:text-lg lg:text-base md:text-base sm:text-base py-2">
                ...
                passion for user-friendly interfaces, I bring creativity to
                life. Let's create something extraordinary together.
              </p>
              <div className="space-x-5">
                <a href="#contact">
                  <button className="bg-slate-950 hover:bg-gray-950 text-slate-50 font-semibold hover:text-slate-50 py-2 px-4 border border-[#888888] hover:border-transparent rounded">
                    Contact
                  </button>
                </a>
